            ...
            MySQL.Async.fetchAll('SELECT * FROM user_inventory WHERE identifier = @identifier', {
                ...
                for i=1, #inventory do
                    ...
                    if item then
                        ...
                        print(('tprp_base: invalid item "%s" ignored!'):format(inventory[i].item))
                    end
                end
            ...
            table.insert(tasks2, function(cb2)
                ...
                MySQL.Async.fetchAll('SELECT job, job_grade, loadout, position FROM users WHERE identifier = @identifier', {
                    ...
                    if ESX.DoesJobExist(job, grade) then
                        ...
                        print(('tprp_base: %s had an unknown job [job: %s, grade: %s], setting as unemployed!'):format(player.getIdentifier(), job, grade))
...
AddEventHandler('playerDropped', function(reason)
    ...
    if xPlayer then
        ...
        TriggerEvent('tprp:PlayerDropped', xPlayer, source)
